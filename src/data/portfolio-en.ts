...
export const portfolioDataEn: PortfolioData = {
  ...
  ui: {
    ...
    resumePageTitle: "Gustavo Fogliati CV",
    resumePageDescription: "View the resume directly in the browser or download the PDF.",
    resumeDownloadLabel: "Download CV",
    resumeOpenLabel: "Open PDF",
